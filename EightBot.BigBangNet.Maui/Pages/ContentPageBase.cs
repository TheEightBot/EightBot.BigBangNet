...
{
    public abstract class ContentPageBase<TViewModel> : ReactiveUI.XamForms.ReactiveContentPage<TViewModel>, IEnableLogger
        where TViewModel : class
    {
        ...
        protected ContentPageBase(bool delayBindingRegistrationUntilActivation = false)
        {

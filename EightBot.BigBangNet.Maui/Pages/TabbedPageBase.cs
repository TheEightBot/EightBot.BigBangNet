...
{
    public abstract class TabbedPageBase<TViewModel> : ReactiveUI.XamForms.ReactiveTabbedPage<TViewModel>, IEnableLogger
        where TViewModel : class
    {
        ...
        protected TabbedPageBase(bool delayBindingRegistrationUntilActivation = false)
        {

...
{
	public abstract class StackLayoutBase<TViewModel> : ReactiveStackLayout<TViewModel>, IEnableLogger 
        where TViewModel : class
	{
        ...
        protected StackLayoutBase (bool delayBindingRegistrationUntilActivation = false)
        {

...
{
	public abstract class FlexLayoutBase<TViewModel> : ReactiveFlexLayout<TViewModel>, IEnableLogger 
        where TViewModel : class
	{
        ...
        protected FlexLayoutBase (bool delayBindingRegistrationUntilActivation = false)
        {
